...
void customRendering(ImVec4 col)
{
	...
	for (int n = 0; n < 2; n++) {
		...
		draw_list->AddRect(ImVec2(x, y), ImVec2(x+sz, y+sz), col32, 0.0f, ImDrawFlags_RoundCornersAll, curr_thickness); x += sz+spacing;
		draw_list->AddRect(ImVec2(x, y), ImVec2(x+sz, y+sz), col32, 10.0f, ImDrawFlags_RoundCornersAll, curr_thickness); x += sz+spacing;
		draw_list->AddRect(ImVec2(x, y), ImVec2(x+sz, y+sz), col32, 10.0f, ImDrawFlags_RoundCornersTopLeft|ImDrawFlags_RoundCornersBottomRight, curr_thickness); x += sz+spacing;
		...
		draw_list->AddBezierCubic(ImVec2(x, y), ImVec2(x+sz*1.3f,y+sz*0.3f), ImVec2(x+sz-sz*1.3f,y+sz-sz*0.3f), ImVec2(x+sz, y+sz), col32, curr_thickness);
		x = p.x + 4;
		y += sz+spacing;
	}
	...
	draw_list->AddRectFilled(ImVec2(x, y), ImVec2(x+sz, y+sz), col32, 10.0f, ImDrawFlags_RoundCornersTopLeft|ImDrawFlags_RoundCornersBottomRight); x += sz+spacing;
